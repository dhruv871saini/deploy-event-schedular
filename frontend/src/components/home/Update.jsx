...
const Update = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (editIndex !== null) {
      ...
      axios.patch(`${process.env.REACT_APP_LOCAL_HOST}/api/v1/events/${data[editIndex]._id}`, formData,{
        headers:{
          Authorization:`Bearer ${datas}`
        }
      })
  ...
  const handleDelete = (index) => {
    ...
    axios.delete(`${process.env.REACT_APP_LOCAL_HOST}/api/v1/events/${eventId}`,{
      headers:{
        Authorization:`Bearer ${datas}`
      }
    })
